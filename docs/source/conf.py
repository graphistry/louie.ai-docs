...
project = "Louie Admin Docs"
copyright = "2024, Graphistry, Inc."
author = "Graphistry, Inc."

html_title = "Louie Administration Documentation"
html_short_title = "Louie Admin"
html_logo = 'static/louie-logo.png'
...
html_theme_options = {
    "repository_url": "https://github.com/graphistry/louie-admin-docs",
    ...
    "logo": {
        "image_light": "static/louie-logo.png",
        "image_dark": "static/louie-logo-dark.png",
    },
}

# Add custom CSS for full-width content
html_css_files = [
    'graphistry.css',
    {
        'rel': 'stylesheet',
...
#   'admin/**': ['localtoc.html', 'relations.html', 'sourcelink.html', 'searchbox.html'],
#   'user/**': ['localtoc.html', 'relations.html', 'sourcelink.html', 'searchbox.html'],
# }
...
htmlhelp_basename = "Louie-admin-doc"
...
man_pages = [(root_doc, "graphistry-admin-docs", u"Louie Admin Documentation", [author], 1)]
